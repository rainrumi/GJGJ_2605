...
func _run() -> void:
	...
	_expect(main.run_state.lara_current_location != null, "5日目のラーラの現在地を予定から取得する")
	...
	_expect(
		main.run_state.lara_current_location.stage_area == main.lara_schedule.get_area(6, 1320),
		"日付更新後のラーラの現在地が予定と一致する"
	)
