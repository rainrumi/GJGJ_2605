...
var battle_start_minutes := START_HOUR * 60 # 開始分
var hp := MAX_HP
...
func start_battle(context: BattleInfo = null) -> void:
	...
	battle_start_minutes = START_HOUR * 60
	minutes = battle_start_minutes
	...
	acid_controller.setup(seed_controller.get_flowers(), battle_start_minutes)
...
func _sync_seed_sources() -> void:
	...
	acid_controller.set_seed_effect_flowers(flowers, battle_start_minutes)
