...
@export var acid_damage_heal_rate := 0.0
@export var acided_nightmare_heal_rate := 0.0
@export var acided_nightmare_max_hp_rate := 0.0
@export var time_active_count_heal_rate := 0.0
@export var hour_heal_rate := 0.0
