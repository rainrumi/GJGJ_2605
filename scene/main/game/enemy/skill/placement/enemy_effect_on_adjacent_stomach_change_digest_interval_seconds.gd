...
# 効果適用
func apply() -> void:
	EnemyEffectWorldActions.add_interval_seconds(source, digestion_interval, interval_delta_seconds * EnemyEffectTargetQuery.get_stomach_edge_contact_count(source, stomach))
